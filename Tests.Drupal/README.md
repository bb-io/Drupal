...
Refresh captures explicitly. Script verifies containers, recreates only connector-owned read/upload jobs, validates authenticated responses, and atomically replaces each fixture file:
